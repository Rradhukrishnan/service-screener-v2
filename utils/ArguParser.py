...
class ArguParser:
    ...
    CLI_ARGUMENT_RULES = {
        ...
        "services": {
            ...
            "default": "rds,ec2,iam,s3,efs,lambda,guardduty,cloudfront,cloudtrail,elasticache,eks,dynamodb,opensearch,kms,cloudwatch,redshift,apigateway,sqs,glue,sagemaker,awsconfig,inspector,ecs,ecr,elasticbeanstalk,securityhub,secretsmanager,wafv2,codebuild,codepipeline,codecommit,codedeploy,controltower,acm,route53,ses,costexplorer,workspaces",
        ...
        "frameworks": {
            "required": False,
            "default": 'MSR,FTR,SSB,WAFS,WAFO,WARL,WAPE,WACO,WASU,CIS,NIST,RMiT,SPIP,RBI'
        },
        "others":{
            "required": False,
            "default": None,
