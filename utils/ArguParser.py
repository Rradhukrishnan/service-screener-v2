...
class ArguParser:
    ...
    CLI_ARGUMENT_RULES = {
        ...
        "services": {
            ...
            "default": "rds,ec2,iam,s3,efs,lambda,guardduty,cloudfront,cloudtrail,elasticache,eks,dynamodb,opensearch,kms,cloudwatch,redshift,apigateway,sqs,glue,sagemaker,awsconfig,inspector,ecs,ecr",
